...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('graphql-sequelize'), require('sequelize'), require('graphql'), require('fs'), require('path'), require('graphql-tools')) :
  typeof define === 'function' && define.amd ? define(['graphql-sequelize', 'sequelize', 'graphql', 'fs', 'path', 'graphql-tools'], factory) :
  (global = global || self, (global.Sifrr = global.Sifrr || {}, global.Sifrr.Api = factory(global.graphqlSequelize, global.sequelize, global.graphql, global.fs, global.path, global.graphqlTools)));
}(this, function (graphqlSequelize, sequelize, graphql, fs, path, graphqlTools) { 'use strict';

  graphqlSequelize = graphqlSequelize && graphqlSequelize.hasOwnProperty('default') ? graphqlSequelize['default'] : graphqlSequelize;
  sequelize = sequelize && sequelize.hasOwnProperty('default') ? sequelize['default'] : sequelize;
  graphql = graphql && graphql.hasOwnProperty('default') ? graphql['default'] : graphql;
  fs = fs && fs.hasOwnProperty('default') ? fs['default'] : fs;
  path = path && path.hasOwnProperty('default') ? path['default'] : path;
  graphqlTools = graphqlTools && graphqlTools.hasOwnProperty('default') ? graphqlTools['default'] : graphqlTools;
