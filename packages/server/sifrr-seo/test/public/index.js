	...
	(function () {
	  ...
	  function Sa(a) {
	    ...
	    for (c = 0; c < b.length; c++) {
	      ...
	      var f = t(d);
	      f = f && f.root;
	      if (0 === c || f && f === e) if (Ra(a, d, "bubble"), d !== window && (e = d.__shady_getRootNode()), a.A) break;
	    }
	  }
	    ...
	    if (b) {
	      ...
	      if ("function" === m || "object" === m) if ("object" !== m || b.handleEvent && "function" === typeof b.handleEvent) {
	        ...
	        h = function (l) {
	          ...
	          if (!w(k) && "slot" !== k.localName || -1 != l.composedPath().indexOf(k)) if (l.composed || -1 < l.composedPath().indexOf(k)) if (Qa(l) && l.target === l.relatedTarget) l.eventPhase === Event.BUBBLING_PHASE && l.stopImmediatePropagation();else if (l.eventPhase === Event.CAPTURING_PHASE || l.bubbles || l.target === k || k instanceof Window) {
	        ...
	        Pa[a] ? (this.__handlers = this.__handlers || {}, this.__handlers[a] = this.__handlers[a] || {
	          capture: [],
	          bubble: []
	  ...
	  function Xa(a, b, c) {
	    if (b) {
	      ...
	      g && Pa[a] && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][c ? "capture" : "bubble"], b = a.indexOf(g), -1 < b && a.splice(b, 1));
	    }
	  }
	  function Ya() {
	    for (var a in Pa) {
	  ...
	  function lb(a) {
	    var b = a;
	    a && "slot" === a.localName && (b = (b = (b = t(a)) && b.l) && b.length ? b[0] : lb(a.__shady_nextSibling));
	    return b;
	  }
	  function mb(a, b, c) {
	    if (a = (a = t(a)) && a.m) {
	  ...
	  var K = A({
	    ...
	    set textContent(a) {
	      ...
	      switch (this.nodeType) {
	        ...
	        case Node.DOCUMENT_FRAGMENT_NODE:
	          ...
	          } else jb(this), (0 < a.length || this.nodeType === Node.ELEMENT_NODE) && this.__shady_insertBefore(document.createTextNode(a));
	          break;
	        default:
	          this.nodeValue = a;
	      }
	    ...
	    insertBefore: function (a, b) {
	      if (this.ownerDocument !== fb && a.ownerDocument !== fb) return this.__shady_native_insertBefore(a, b), a;
	      ...
	      f = !0;
	      var m = (!gb || void 0 === a.__noInsertionPoint && void 0 === this.__noInsertionPoint) && !ob(a, e),
	          k = c && !a.__noInsertionPoint && (!gb || a.nodeType === Node.DOCUMENT_FRAGMENT_NODE);
	      if (k || m) m && (g = g || H(a)), pb(a, function (l) {
	      ...
	      v(this) && (sb(a, this, b), c = t(this), ja(this) ? (J(c.root), f = !1) : c.root && (f = !1));
	      f ? (c = w(this) ? this.host : this, b ? (b = lb(b), c.__shady_native_insertBefore(a, b)) : c.__shady_native_appendChild(a)) : a.ownerDocument !== this.ownerDocument && this.ownerDocument.adoptNode(a);
	      return a;
	    },
	  ...
	  var Fb = A({
	    ...
	    setAttribute: function (a, b) {
	      this.ownerDocument !== Bb ? this.__shady_native_setAttribute(a, b) : Ab(this, a, b) || (this.__shady_native_setAttribute(a, b), Cb(this, a));
	    },
	    removeAttribute: function (a) {
	      this.ownerDocument !== Bb ? this.__shady_native_removeAttribute(a) : Ab(this, a, "") ? "" === this.getAttribute(a) && this.__shady_native_removeAttribute(a) : (this.__shady_native_removeAttribute(a), Cb(this, a));
	    }
	  }),
	      Ib = A({
	  ...
	  var Nb = Mb("area base br col command embed hr img input keygen link meta param source track wbr".split(" ")),
	  ...
	  var Qb = document.implementation.createHTMLDocument("inert"),
	      Rb = A({
	    get innerHTML() {
	      return v(this) ? Pb("template" === this.localName ? this.content : this, ta) : this.__shady_native_innerHTML;
	    },
	    set innerHTML(a) {
	      if ("template" === this.localName) this.__shady_native_innerHTML = a;else {
	        jb(this);
	        var b = this.localName || "div";
	        b = this.namespaceURI && this.namespaceURI !== Qb.namespaceURI ? Qb.createElementNS(this.namespaceURI, b) : Qb.createElement(b);
	  ...
	  var Tb = A({
	    ...
	    addEventListener: function (a, b, c) {
	      if ("slot" !== this.localName || "slotchange" === a) Va.call(this, a, b, c);else {
	        "object" !== typeof c && (c = {
	          capture: !!c
	        });
	  ...
	  var Wb = window.document,
	    ...
	    importNode: function (a, b) {
	      if (a.ownerDocument !== Wb || "template" === a.localName) return this.__shady_native_importNode(a, b);
	  ...
	  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML") && (R.innerHTML = Rb.innerHTML);
	  Object.getOwnPropertyDescriptor(HTMLElement.prototype, "className") && (R.className = Fb.className);
	  var S = {
	    EventTarget: [eb],
	    ...
	    Element: [Fb, N, M, !u.c || "innerHTML" in Element.prototype ? Rb : null, window.HTMLSlotElement ? null : Tb],
	    HTMLElement: [Sb, R],
	    HTMLSlotElement: [Tb],
	  ...
	  if (window.customElements && u.D && !u.preferPerformance) {
	    ...
	    var nc = function (a, b, c) {
	      ...
	      if (b || c) a.prototype.connectedCallback = a.prototype.__shadydom_connectedCallback = function () {
	        ...
	        U ? this.isConnected || mc.set(this, !1) : this[e] && (this[e] = !1, c && c.call(this));
	      };
	      return a;
	    },
	  ...
	  function W(a, b) {
	    ...
	    for (var c = 0; c < b.length; c++) {
	      ...
	      e && (Object.defineProperty(a, "__shady_native_" + d, e), e.value ? vc[d] || (vc[d] = e.value) : xc(d));
	    }
	  }
	  ...
	  function Cc() {
	    ...
	    uc ? W(Node.prototype, "parentNode firstChild lastChild previousSibling nextSibling childNodes parentElement textContent".split(" ")) : V(Node.prototype, {
	      parentNode: {
	        get: function () {
	          X.currentNode = this;
	          return X.parentNode();
	    ...
	    uc ? (W(Element.prototype, Ac), W(Element.prototype, ["previousElementSibling", "nextElementSibling", "innerHTML", "className"]), W(HTMLElement.prototype, ["children", "innerHTML", "className"])) : (V(Element.prototype, a), V(Element.prototype, {
	      ...
	      innerHTML: {
	        ...
	        set: function (b) {
	          ...
	          d = this.namespaceURI && this.namespaceURI !== yc.namespaceURI ? yc.createElementNS(this.namespaceURI, d) : yc.createElement(d);
	          d.innerHTML = b;
	    ...
	    uc ? (W(Document.prototype, Ac), W(Document.prototype, ["activeElement"])) : V(Document.prototype, a);
	  ...
	  if (u.D) {
	    ...
	    window.ShadyDOM = {
	      ...
	      wrap: u.g ? Ec : Fc,
	      wrapIfNeeded: !0 === u.g ? Ec : function (a) {
	        return a;
	      },
	      Wrapper: Z,
	      composedPath: Ma,
